...
func (mock *MockSender) Send(log *logging.SimpleLogger, applyResult webhooks.CommandResult) error {
	if mock == nil {
...
func (verifier *VerifierMockSender) Send(log *logging.SimpleLogger, applyResult webhooks.CommandResult) *MockSender_Send_OngoingVerification {
	params := []pegomock.Param{log, applyResult}
...
func (c *MockSender_Send_OngoingVerification) GetCapturedArguments() (*logging.SimpleLogger, webhooks.CommandResult) {
	log, applyResult := c.GetAllCapturedArguments()
	return log[len(log)-1], applyResult[len(applyResult)-1]
}

func (c *MockSender_Send_OngoingVerification) GetAllCapturedArguments() (_param0 []*logging.SimpleLogger, _param1 []webhooks.CommandResult) {
