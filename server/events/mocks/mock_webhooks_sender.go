...
func (mock *MockWebhooksSender) Send(log *logging.SimpleLogger, res webhooks.CommandResult) error {
	if mock == nil {
...
func (verifier *VerifierMockWebhooksSender) Send(log *logging.SimpleLogger, res webhooks.CommandResult) *MockWebhooksSender_Send_OngoingVerification {
	params := []pegomock.Param{log, res}
...
func (c *MockWebhooksSender_Send_OngoingVerification) GetCapturedArguments() (*logging.SimpleLogger, webhooks.CommandResult) {
	log, res := c.GetAllCapturedArguments()
	return log[len(log)-1], res[len(res)-1]
}

func (c *MockWebhooksSender_Send_OngoingVerification) GetAllCapturedArguments() (_param0 []*logging.SimpleLogger, _param1 []webhooks.CommandResult) {
